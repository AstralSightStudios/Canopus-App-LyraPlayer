...
- 选择已连接的小米穿戴设备；
- 本地导入 MP3，并可附带 JPG/PNG 封面和 LRC/JSON/TXT 歌词；封面会在插件内预处理为 180×180 LVGL v9 ARGB8888 BIN，并从同一封面生成混色模糊背景（底部 40px 透明渐隐），尺寸按所选设备名决定：小米手环 11 为 212×520，小米手环 10 Pro 及无法识别的设备为 336×520；
