-- One-shot Canopus installer watchface for Lyra Player.
-- Opening it stages the signed CMI1 receipt and ELF, then asks the resident
-- supervisor to install the module in the disabled state.
local lvgl = require("lvgl")

local TOKEN = "lyra_player"
...
lvgl.Label(root, {
    text = "Lyra Player", text_color = 0xFFFFFF,
...
local function install()
    ...
    status:set { text = "Installed — disabled by default.\n\n"
        .. "Open Canopus Manager, enable Lyra Player, then reboot and LOAD.\n\n"
